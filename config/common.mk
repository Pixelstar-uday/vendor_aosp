...
PRODUCT_COPY_FILES += \
    vendor/pixelstar/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/android.software.nfc.beam.xml
...
include vendor/pixelstar/config/aosp_audio.mk

# Include Pixelstar audio files
include vendor/pixelstar/config/pixelstar_audio.mk
